...
/*	$sql="INSERT INTO tbl_user " .
	...
	*/
		$sql="INSERT INTO tbl_user  (id,username,userpwd,qq,anums,ctime,userid,beizhu1,beizhu2,shuyu)"."VALUES(
	0,
	'".$_POST["username"]."',
	'".$pwd."',
	'".$_POST["qq"]."',
...
?>
    ...
    <li><label>文章数量</label><input name="anums" type="text" class="dfinput"  value="<?=$row['anums']?>" /><i></i></li>
	<li><label>到期时间</label><input name="beizhu1" type="text" class="dfinput"  value="<?=$row['beizhu1']?>" /><i>时间格式：2016-02-17</i></li>
