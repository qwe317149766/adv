<div class="bot_main">
	<ul>
		<li class="ico_1 <?php if($uri =='login.php'){echo 'select';}?>" onclick="window.location.href='register.php'" style="width:25%;"><span class="ico"><img src="images/1.png" /></span><span class="txt">帐号注册</span></li>
