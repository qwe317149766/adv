...
<div class="blank10"></div>  
      ...
      <div class="btn_box" style="margin-bottom:10px;" align="center">
       ...
       <dd> <input type="text" value="<?php echo $row['title']?>" style="width:500px" name="title"></dd>
		...
		<dd> 
		 <script id="editora" name="gongzhonghao" type="text/plain"><?php  $html_gongzhonghao=str_replace('http://mmbiz','http://mmbiz',$row['gongzhonghao']);echo $html_gongzhonghao;?></script></dd></dl>
		...
		<dd> 
		  <script id="editor" name="content" type="text/plain"><?php  $html_content=str_replace('http://mmbiz','http://mmbiz',$row['content']);echo $html_content;?></script></dd></dl>
