...
if($_GET['act']=='add'){
	...
	$content=preg_replace("/<(\/?iframe.*?)>.*(allowfullscreen)>$/si","",$arr[0]['content']); //过滤frame标签
	if($vid!==''){
	...
	mysql_query($sql);
	echo "<script type='text/javascript'>alert('\u53d1\u5e03\u6210\u529f\uff01');location.href='edit_article.php?fid=".$infoid."';</script>";
}
?>
<!DOCTYPE HTML>
<html>
	...
	<form action="?act=add" id="signupok" method="post" name="addform"  enctype="multipart/form-data">
       <input type="hidden" name="artid" value="<?php echo time().rand(10,1000);?>" />
        ...
        <dl class="clearfix">
          ...
          <div class="btn_box">
        <input type="button" name="signup" class="button" value="购买会员" onClick="window.open('buy.php');" style="width:49%;height:30px;line-height:30px" align="left">
        <input type="button" name="signup" class="button" value="直接发布" onClick="window.open('add_article.php');" style="width:49%;height:30px;line-height:30px" align="right" >
      </div>
		 ...
		 <div class="cjfenlei"> <a id="pc_0" class="cjclas" href="javascript:void(0);">热门</a> <a id="pc_1" class="cjclas" href="javascript:void(0);">推荐</a> <a id="pc_2" class="cjclas" href="javascript:void(0);">段子</a> <a id="pc_3" class="cjclas" href="javascript:void(0);">养生</a> <a id="pc_4" class="cjclas" href="javascript:void(0);">私房</a> <a id="pc_5" class="cjclas" href="javascript:void(0);">八卦</a> <a id="pc_6" class="cjclas" href="javascript:void(0);">生活</a> <a id="pc_7" class="cjclas" href="javascript:void(0);">财经</a> <a id="pc_8" class="cjclas" href="javascript:void(0);">汽车</a> <a id="pc_9" class="cjclas" href="javascript:void(0);">科技</a> <a id="pc_10" class="cjclas" href="javascript:void(0);">潮人</a> <a id="pc_11" class="cjclas" href="javascript:void(0);">辣妈</a> <a id="pc_12" class="cjclas" href="javascript:void(0);">点赞</a> <a id="pc_13" class="cjclas" href="javascript:void(0);">旅行</a> <a id="pc_14" class="cjclas" href="javascript:void(0);">职场</a> <a id="pc_15" class="cjclas" href="javascript:void(0);">美食</a> <a id="pc_16" class="cjclas" href="javascript:void(0);">古今</a> <a id="pc_17" class="cjclas" href="javascript:void(0);">学霸</a> <a id="pc_18" class="cjclas" href="javascript:void(0);">星座</a> <a id="pc_19" class="cjclas" href="javascript:void(0);">体育</a> <a id="pc_20" class="cjclas" href="http://weixin.sogou.com/?p=73141200&kw=">更多</a> </div>
